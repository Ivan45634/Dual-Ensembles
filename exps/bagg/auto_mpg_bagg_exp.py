...
be_params = {
    'base_estimator': [BoostingElementaryPredicatesv2(num_iter=i, m=j, max_cov=500, learning_rate=0.5) 
    for i in np.linspace(300, 600, 5).astype(int).tolist() for j in list(range(2, 21))],
    'n_estimators': [10, 50, 100],
    'sub_sample_size': [0.5],
    'sub_feature_size': [0.7],
